...
const paDataFallback = [
  {
    ...
    modell: 'Wolf CHA-07',
    kw: 'A-7/W35: 1,6–6,8 · HK −11: 7,4 kW',
    ...
    specs: [
      ['Heizleistung A-7/W35', '1,6–6,8 kW'],
      ['WP @ −11 °C (W35/W55)', 'ca. 6,33 / 5,95 kW'],
      ['HeroWerk-Auslegung HK', 'ca. 7,4 kW (WP ÷ 0,80)'],
      ...
      ['Effizienzklasse', 'A++/A+++ (35 °C) · A++ (55 °C)'],
      ['JAZ Heizkörper¹', '3,96'],
      ['JAZ Fußbodenheizung¹', '4,92'],
      ['Abmessung außen (BxHxT)', '1.286 × 586 × 902 mm'],
  ...
  },
  {
    ...
    modell: 'Wolf CHA-10',
    kw: 'A-7/W35: 2,2–9,9 · HK −11: 9,7 kW',
    ...
    specs: [
      ['Heizleistung A-7/W35', '2,2–9,9 kW'],
      ['WP @ −11 °C (W35/W55)', 'ca. 8,90 / 7,78 kW'],
      ['HeroWerk-Auslegung HK', 'ca. 9,7 kW (WP ÷ 0,80)'],
      ['Heizstab (optional)', '9 kW'],
      ['Kältemittel', 'R290 (Propan, natürlich)'],
      ['Bauart', 'Monoblock (Außenaufstellung)'],
      ['Vorlauftemp.', 'bis 70 °C'],
  ...
  },
  {
    ...
    kw: 'A-7/W35: bis 16,7 · HK −11: 17,7 kW',
    ...
    specs: [
      ['Heizleistung A-7/W35', 'bis 16,7 kW'],
      ['WP @ −11 °C (W35/W55)', 'ca. 15,05 / 14,15 kW'],
      ['HeroWerk-Auslegung HK', 'ca. 17,7 kW (WP ÷ 0,80)'],
      ['Heizstab (optional)', '9 kW'],
      ['Kältemittel', 'R290 (Propan, natürlich)'],
      ['Bauart', 'Monoblock (Außenaufstellung)'],
      ['Vorlauftemp.', 'bis 70 °C'],
  ...
  },
  {
    ...
    kw: 'A-7/W35: bis 20,4 · HK −11: 22,4 kW',
    ...
    specs: [
      ['Heizleistung A-7/W35', 'bis 20,4 kW'],
      ['WP @ −11 °C (W35/W55)', 'ca. 18,82 / 17,90 kW'],
      ['HeroWerk-Auslegung HK', 'ca. 22,4 kW (WP ÷ 0,80)'],
      ['Heizstab (optional)', '9 kW'],
      ['Kältemittel', 'R290 (Propan, natürlich)'],
      ['Bauart', 'Monoblock (Außenaufstellung)'],
      ['Vorlauftemp.', 'bis 70 °C'],
  ...
  },
  {
    ...
    specs: [
      ...
      ['WP @ −11 °C (W35/W55)', 'ca. 30,10 / 28,30 kW'],
      ['HeroWerk-Auslegung HK', 'ca. 35,4 kW (WP ÷ 0,80)'],
      ['Kältemittel', 'R290 (Propan, natürlich)'],
      ['Bauart', '2er-Kaskade (Außenaufstellung)'],
      ['Vorlauftemp.', 'bis 70 °C'],
      ['Kaskadierung', 'bis 5 Außengeräte / max. 100 kW'],
      ['Effizienzklasse', 'A+++ (systemabhängig)'],
      ['JAZ Heizkörper¹', 'projektbezogen zu berechnen'],
      ['JAZ Fußbodenheizung¹', 'projektbezogen zu berechnen'],
...
const paDataFallbackVaillant = [
  ...
  },
  {
    ...
    kw: 'A-7/W35: 10,58 · HK −11: 12,7 kW',
    icon: paDataFallback[2].icon,
    img: 'vwl-l.jpg',
    desc: 'Für größere Häuser mit höherem Wärmebedarf',
    specs: [
      ['Heizleistung A-7/W35', '10,58 kW (COP 3,01)'],
      ['WP @ −11 °C (W35/W55)', '10,18 / 10,17 kW'],
      ['HeroWerk-Auslegung HK', 'ca. 12,7 kW (WP ÷ 0,80)'],
  ...
  },
  {
    ...
    kw: 'A-7/W35: 24,28 · HK −11: 27,8 kW',
    imgPos: 'center 70%',
    ...
    specs: [
      ...
      ['WP @ −11 °C (W35/W55)', '21,98 / 22,22 kW'],
      ['HeroWerk-Auslegung HK', 'ca. 27,8 kW (WP ÷ 0,80)'],
      ['Kältemittel', 'R290 (Propan, natürlich)'],
...
function paUpdateDetail(d) {
  ...
  const hasJaz = d.specs.some((s) => s[0].startsWith('JAZ'));
  document.getElementById('paSpecsTable').querySelector('tbody').innerHTML = d.specs
    .map((s) => {
      const isHighlight = s[0].startsWith('JAZ');
  ...
  if (d.eigen !== null) {
    ...
    if (isZfhCard) {
      ...
      const referenceText = isVaillantCard
        ...
        : 'Referenzkonfiguration: 6 WE MFH, 2× Wolf CHA-16/20 Kaskade. Förderung bei MFH stark abhängig von Anzahl der Wohneinheiten und Eigentümerstruktur. Individuelle Planung erforderlich.';
